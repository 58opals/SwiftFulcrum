...
extension FulcrumClient {
    ...
    public func submit<RegularResponseResult: JSONRPCResponse>(
        ...
        } catch let fulcrumError as FulcrumClient.Error {
            throw fulcrumError
        } catch {
            throw FulcrumClient.Error.client(.unknown(error))
        }
    }
    ...
    public func subscribe<Initial: JSONRPCResponse, Notification: JSONRPCResponse>(
        method: FulcrumMethodRequest,
...
extension FulcrumClient {
    ...
    private func makeSubscription<Initial: JSONRPCResponse, Notification: JSONRPCResponse>(
        method: FulcrumMethodRequest,
