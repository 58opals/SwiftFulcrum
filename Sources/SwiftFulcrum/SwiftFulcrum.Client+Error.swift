// SwiftFulcrum.Client+Error.swift
...
extension SwiftFulcrum.Client.Error.NetworkModel: Swift.Error, Equatable, Sendable {
    public static func == (lhs: SwiftFulcrum.Client.Error.NetworkModel, rhs: SwiftFulcrum.Client.Error.NetworkModel) -> Bool {
        switch (lhs, rhs) {
...
extension SwiftFulcrum.Client.Error.ServerModel: Swift.Error, Equatable, Sendable {}
