...
extension SwiftFulcrum.RPC.Response.ResultModel.Blockchain.Transaction {
            public struct Get: SwiftFulcrum.RPC.ResponseProtocol {
                ...
                public struct Input: Decodable, Sendable {
                    ...
                    init(from json: SwiftFulcrum.RPC.Response.JSONRPCModel.Result.Blockchain.Transaction.Get.Detailed.Input) {
                    ...
                    public struct ScriptSig: Decodable, Sendable {
                        ...
                        init(from json: SwiftFulcrum.RPC.Response.JSONRPCModel.Result.Blockchain.Transaction.Get.Detailed.Input.ScriptSig) {
                ...
                public struct Output: Decodable, Sendable {
                    ...
                    init(from json: SwiftFulcrum.RPC.Response.JSONRPCModel.Result.Blockchain.Transaction.Get.Detailed.Output) {
                        self.index = json.n
                    ...
                    public struct ScriptPubKey: Decodable, Sendable {
                        ...
                        init(from json: SwiftFulcrum.RPC.Response.JSONRPCModel.Result.Blockchain.Transaction.Get.Detailed.Output.ScriptPubKey) {
                ...
                public typealias JSONRPCModel = SwiftFulcrum.RPC.Response.JSONRPCModel.Result.Blockchain.Transaction.Get
                public init(fromRPC jsonrpc: JSONRPCModel) throws {
                    switch jsonrpc {
                    case .raw(let raw):
                        throw SwiftFulcrum.RPC.Response.ResultModel.Error.unexpectedFormat("Expected detailed transaction information; received raw hex string: \(raw)")
                    case .detailed(let detailed):
                        guard let blockHash = detailed.blockhash else { throw SwiftFulcrum.RPC.Response.ResultModel.Error.missingField("blockhash") }
                        guard let blocktime = detailed.blocktime else { throw SwiftFulcrum.RPC.Response.ResultModel.Error.missingField("blocktime") }
                        guard let confirmations = detailed.confirmations else { throw SwiftFulcrum.RPC.Response.ResultModel.Error.missingField("confirmations") }
                        guard let time = detailed.time else { throw SwiftFulcrum.RPC.Response.ResultModel.Error.missingField("time") }
