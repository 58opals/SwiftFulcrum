...
extension SwiftFulcrum.RPC.Response.ResultModel.Blockchain {
        public struct Block {
            public struct Header: SwiftFulcrum.RPC.ResponseProtocol {
                ...
                public typealias JSONRPCModel = SwiftFulcrum.RPC.Response.JSONRPCModel.Result.Blockchain.Block.Header
            ...
            public struct Headers: SwiftFulcrum.RPC.ResponseProtocol {
                ...
                public typealias JSONRPCModel = SwiftFulcrum.RPC.Response.JSONRPCModel.Result.Blockchain.Block.Headers
                public init(fromRPC jsonrpc: JSONRPCModel) {
