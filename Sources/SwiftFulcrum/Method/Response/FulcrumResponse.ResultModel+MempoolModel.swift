...
extension FulcrumResponse.ResultModel {
    public struct MempoolModel {
        public struct GetInfoModel: JSONRPCResponse {
            ...
            public typealias JSONRPCModel = FulcrumResponse.JSONRPCModel.ResultModel.MempoolModel.GetInfoModel
        ...
        public struct GetFeeHistogramModel: JSONRPCResponse {
            ...
            public struct ResultModel: Decodable, Sendable {
                ...
                init(from pair: FulcrumResponse.JSONRPCModel.ResultModel.MempoolModel.FeeHistogram) throws {
            ...
            public typealias JSONRPCModel = FulcrumResponse.JSONRPCModel.ResultModel.MempoolModel.GetFeeHistogramModel
