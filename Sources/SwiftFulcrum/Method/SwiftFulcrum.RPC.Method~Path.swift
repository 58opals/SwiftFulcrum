// SwiftFulcrum.RPC.Method~Path.swift
...
extension SwiftFulcrum.RPC.Method.ServerModel { var path: String {
    switch self {
...
extension SwiftFulcrum.RPC.Method.BlockchainModel { var path: String {
    switch self {
...
extension SwiftFulcrum.RPC.Method.BlockchainModel.ScriptHash { var path: String {
    switch self {
...
extension SwiftFulcrum.RPC.Method.BlockchainModel.Address { var path: String {
    switch self {
    case .getBalance: return "get_balance"
    case .getFirstUse: return "get_first_use"
    case .getHistory: return "get_history"
...
extension SwiftFulcrum.RPC.Method.BlockchainModel.Block { var path: String {
    switch self {
    case .header: return "header"
    case .headers: return "headers"
    }}}

extension SwiftFulcrum.RPC.Method.BlockchainModel.Header { var path: String {
    switch self {
    case .get: return "get"
    }}}

extension SwiftFulcrum.RPC.Method.BlockchainModel.Headers { var path: String {
    switch self {
...
extension SwiftFulcrum.RPC.Method.BlockchainModel.Transaction { var path: String {
    switch self {
...
extension SwiftFulcrum.RPC.Method.BlockchainModel.Transaction.DSProof { var path: String {
    switch self {
    case .get: return "get"
...
extension SwiftFulcrum.RPC.Method.BlockchainModel.UTXO { var path: String {
    switch self {
    case .getInfo: return "get_info"
    }}}

extension SwiftFulcrum.RPC.Method.MempoolModel { var path: String {
    switch self {
    case .getInfo: return "get_info"
