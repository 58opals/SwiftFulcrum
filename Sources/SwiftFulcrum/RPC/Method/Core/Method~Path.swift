...
extension SwiftFulcrum.RPC.Method.Server { var path: String {
    switch self {
...
extension SwiftFulcrum.RPC.Method.Blockchain { var path: String {
    switch self {
...
extension SwiftFulcrum.RPC.Method.Blockchain.ScriptHash { var path: String {
    switch self {
...
extension SwiftFulcrum.RPC.Method.Blockchain.Address { var path: String {
    switch self {
    case .getBalance: return "get_balance"
    case .getFirstUse: return "get_first_use"
    case .getHistory: return "get_history"
...
extension SwiftFulcrum.RPC.Method.Blockchain.Header { var path: String {
    switch self {
    case .get: return "get"
    }}}

extension SwiftFulcrum.RPC.Method.Blockchain.Headers { var path: String {
    switch self {
...
extension SwiftFulcrum.RPC.Method.Blockchain.Transaction.DSProof { var path: String {
    switch self {
    case .get: return "get"
...
extension SwiftFulcrum.RPC.Method.Blockchain.UTXO { var path: String {
    switch self {
    case .getInfo: return "get_info"
    }}}

extension SwiftFulcrum.RPC.Method.Mempool { var path: String {
    switch self {
    case .getInfo: return "get_info"
