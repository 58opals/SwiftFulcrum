...
extension SwiftFulcrum.RPC.Response.Result.Blockchain {
        public struct Block {
            public struct Header: SwiftFulcrum.RPC.ResponseProtocol {
                ...
                public typealias JSONRPC = SwiftFulcrum.RPC.Response.JSONRPC.Result.Blockchain.Block.Header
            ...
            public struct Headers: SwiftFulcrum.RPC.ResponseProtocol {
                ...
                public typealias JSONRPC = SwiftFulcrum.RPC.Response.JSONRPC.Result.Blockchain.Block.Headers
                public init(fromRPC jsonrpc: JSONRPC) {
