...
extension WebSocketModel {
    actor ReconnectorModel {
        ...
        private let network: FulcrumClient.Configuration.NetworkModel
        private let serverCatalogLoader: FulcrumServerCatalogRepository
        ...
        func attemptReconnection(
            ...
            throw FulcrumClient.Error.transport(
