// ProtocolVersionModel+RangeModel.swift

extension ProtocolVersionModel {
    public struct RangeModel: Equatable, Sendable {
        ...
        public func chooseNegotiatedVersion(with peerRange: ProtocolVersionModel.RangeModel) throws -> ProtocolVersionModel {
