...
extension FulcrumClient.Configuration {
    public struct ProtocolNegotiationModel: Sendable {
        ...
        public var supportedRange: ProtocolVersionModel.Range {
            get throws {
                guard let range = ProtocolVersionModel.Range(min: min, max: max) else {
...
extension FulcrumClient.Configuration.ProtocolNegotiationModel {
    public struct Argument: Encodable, Sendable {
        ...
        public init(range: ProtocolVersionModel.Range) {
