...
extension PublicAPIFacadeContractValidator {
    ...
    func excludeRemovedWrapperTypesFromGeneratedPublicSymbolGraph() throws {
        ...
        let requiredSymbols = [
            ...
            "SwiftFulcrum.Client.Configuration.init(reconnect:connectionTimeout:maximumMessageSize:bootstrapServers:serverCatalogLoader:network:protocolNegotiation:)",
            "SwiftFulcrum.Client.Call.Options",
            "SwiftFulcrum.Client.Call.Options.init(timeout:cancellation:subscriptionBufferPolicy:)",
            "SwiftFulcrum.Client.SubscriptionBufferPolicy",
            "SwiftFulcrum.Client.SubscriptionBufferPolicy.bounded(capacity:)",
            "SwiftFulcrum.Client.SubscriptionBufferPolicy.unbounded",
            "SwiftFulcrum.Client.SubscriptionBufferPolicy.defaultPolicy",
            "SwiftFulcrum.Client.Subscription",
            "SwiftFulcrum.Client.Subscription.Updates",
            ...
            "SwiftFulcrum.API.Blockchain.RPA.history(prefix:fromHeight:toHeight:)",
            "SwiftFulcrum.API.Blockchain.RPA.mempool(prefix:)",
            ...
            "SwiftFulcrum.Response.Blockchain.RPA.History.Transaction",
            "SwiftFulcrum.Response.Blockchain.RPA.Mempool",
            "SwiftFulcrum.Response.Blockchain.RPA.Mempool.Transaction",
